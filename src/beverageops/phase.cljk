(ns beverageops.phase
  "Phase gate for the beverage-crop plantation operations coordinator
  rollout (0->3 maturity). Mirrors `orchardops.phase`
  (cloud-itonami-isic-0122) in shape, adapted to this actor's simpler op
  ...
  Phase 1: supervised operation -- always-escalate ops
    (`beverageops.governor/always-escalate-ops`) escalate even when clean;
