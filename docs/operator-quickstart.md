# Operator Quickstart — Beverage Crop Plantation Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0127** (`cloud-itonami-isic-0127`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0127.git
cd cloud-itonami-isic-0127
```
...
- Blueprint governor key: `beverage-operations-governor`
