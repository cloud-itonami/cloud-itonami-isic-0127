...
(require '[cljs.test :as t]
         '[beverageops.facts-test]
         '[beverageops.governor-test]
         '[beverageops.phase-test]
         '[beverageops.registry-test]
         '[beverageops.store-test])

(defmethod t/report [:cljs.test/default :end-run-tests] [m]
  (when-not (t/successful? m) (set! (.-exitCode js/process) 1)))

(t/run-tests 'beverageops.facts-test
              'beverageops.governor-test
              'beverageops.phase-test
              'beverageops.registry-test
              'beverageops.store-test)
